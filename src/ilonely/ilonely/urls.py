...
urlpatterns = [
    ...
    url(r'^delete_comment$', pages.views.delete_comment, name='delete_comment'),
    url(r'^post_comment$', pages.views.post_comment, name='post_comment'),
    ...
    url(r'^post/(?P<postid>\d+)/$', pages.views.post, name='post'),
